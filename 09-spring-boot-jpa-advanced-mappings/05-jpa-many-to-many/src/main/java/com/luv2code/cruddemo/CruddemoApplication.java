...
public class CruddemoApplication {
	...
	public CommandLineRunner commandLineRunner(AppDAO appDAO) {
		return runner -> {
			...
			//findCoursesAndStudentsByCourseId(appDAO);
			//findStudentsAndCoursesByStudentId(appDAO);
			//addMoreCoursesForStudent(appDAO);
			//deleteCourseByIdWithNotStudents(appDAO);
			deleteStudentByIdWithNotCourses(appDAO);
		};
	}

	private void deleteStudentByIdWithNotCourses(AppDAO appDAO) {
		appDAO.deleteStudentByIdWithNotCourses(2);
		System.out.println("Deleted student with id: 2");
	}

	private void deleteCourseByIdWithNotStudents(AppDAO appDAO) {
		appDAO.deleteCourseByIdWithNotStudents(10);
		System.out.println("Deleted course with id: 10");
	}

	private void addMoreCoursesForStudent(AppDAO appDAO) {
		Student student = appDAO.findStudentsAndCoursesByStudentId(2);
		System.out.println("Found student: " + student);
		System.out.println("Courses: " + student.getCourses());

		student.add(new Course("asd"));
		student.add(new Course("asddddd"));
	...
	private void findCoursesAndStudentsByCourseId(AppDAO appDAO) {
		Course course = appDAO.findCoursesAndStudentsByCourseId(10);
	...
	private void createCourseAndStudents(AppDAO appDAO) {
		...
		course.add(new Student("Kadri", "Acibadem","kadriacibadem@gmail.com"));
		course.add(new Student("Kadri2", "Acibadem2","kadri2@gmail.com"));
		appDAO.save(course);
	}
	...
	private void findCourseAndReviewsById(AppDAO appDAO) {
		System.out.println(appDAO.findCourseAndReviewsById(10));
	}
